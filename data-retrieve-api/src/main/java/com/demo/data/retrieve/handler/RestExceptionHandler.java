package com.demo.data.retrieve.handler;

import com.demo.data.retrieve.model.ErrorResponseBean;
import com.demo.data.retrieve.model.Response;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> globalExceptionHandler(
        ...
        return ResponseEntity.internalServerError().body(new Response(new ErrorResponseBean(5000, "Internal Server Error")));
    }
}